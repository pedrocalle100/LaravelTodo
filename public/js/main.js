//Se instancian los iconos en svg para ser copiados en elementos subsecuentes
...
//función para cargar las funciones en el momento de que se cargue la página
window.onload = function(){

  //Al hacer click en el botón "add", captura el valor que está en el campo de imput y resetea el campo de imput al valor por defecto
  ...
  //función para agregar elementos nuevos a la lista de tareas por hacer, se captura el valor que hay en el campo de imput y se crea un nuevo elemento de la lista
  //incluido los botones de remover elemento y completar elemento
  ...
  //función para remover elemento de la lista
  function removeItem(){
  ...
  //marca al elemento de la lista como completado
  function completeItem(){
    var item = this.parentNode.parentNode;
    var parent = item.parentNode;
    var id = parent.id;

    //var target = (id === 'todo') ? document.getElementeById('todo')
